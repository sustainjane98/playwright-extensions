...
type ResultWithArray<STATE> = WaitForResults<Locator, CalcBoolean<STATE>>[] | WaitForResults<null, CalcBoolean<STATE>> | WaitForResults<Locator, CalcBoolean<STATE>>;
type Result<STATE> =  WaitForResults<Locator, CalcBoolean<STATE>> | WaitForResults<null, CalcBoolean<STATE>>
