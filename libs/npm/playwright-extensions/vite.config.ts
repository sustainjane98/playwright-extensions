...
import { default as packageJSON, version, main, module, entr} from './package.json'
import fs from "fs";
  ...
  plugins: [
    ...
    dts({
      afterBuild: ()=>{
        ...
        fs.writeFileSync(path.join(__dirname, '../../../dist/libs/playwright-extensions/package.json'), JSON.stringify({...packageJSON, main: mainRes, module: moduleRes}, null, 2))
      },
      entryRoot: 'src',
